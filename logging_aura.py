...
class LoggingManager:
    ...
    def log_aura_change(self, guild_id: int, recipient_id: int, user_id: int, event: ReactionEvent, emoji: str, points: int, url: str) -> None:
    ...
    def log_event(self, guild_id: int, recipient_id: int, user_id: int, event: LogEvent, points: int=None) -> None:
